...
class podar {
    ...
    public void start()
    {
        ...
        x = (int)(Math.random()*(screen.width - 100)); // Отступ слева в пикселях, получаем случайным образом от 0 до 700
        act = true; // 
    }
    ...
    public void vniz()
    {
       ...
       if ((y+img.getHeight(null))>=(screen.height)) // Если подарок достиг нижней границы
       {
